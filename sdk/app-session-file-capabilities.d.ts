 ...
 */
export type AppSessionFileCapability = "app/session.stage-file";
/** Gates App resource staging and registration; source read and target ownership are checked separately. */
export declare const APP_SESSION_STAGE_FILE_CAPABILITY: AppSessionFileCapability;
export declare const APP_SESSION_FILE_CAPABILITY_WORDS: readonly AppSessionFileCapability[];
//# sourceMappingURL=app-session-file-capabilities.d.ts.map